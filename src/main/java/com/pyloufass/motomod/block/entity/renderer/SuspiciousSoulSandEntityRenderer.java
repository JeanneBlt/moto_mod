package com.pyloufass.motomod.block.entity.renderer;
...
public class SuspiciousSoulSandEntityRenderer  implements BlockEntityRenderer<SuspiciousSoulSandEntity> {
    ...
    public void render(
            SuspiciousSoulSandEntity brushableBlockEntity, float f, MatrixStack matrixStack, VertexConsumerProvider vertexConsumerProvider, int i, int j, Vec3d vec3d
    ) {
