...
public class MotoBondWithPlayerGoal extends Goal {
    private final AbstractMotoEntity horse;
    private final double speed;
    private double targetX;
    private double targetY;
    private double targetZ;

    public MotoBondWithPlayerGoal(AbstractMotoEntity horse, double speed) {
        this.horse = horse;
        this.speed = speed;
